...
const DEFAULT_TRANSLATIONS: CreateTranslationDto[] = [
  ...
  { key: 'dashboard.noRisks', zh: '暂无风险提醒', en: 'No risk alerts', module: 'dashboard' },
  { key: 'dashboard.overdueTaskList', zh: '逾期任务', en: 'Overdue tasks', module: 'dashboard' },
  { key: 'dashboard.followUps', zh: '近期客户跟进', en: 'Upcoming follow-ups', module: 'dashboard' },
  ...
  { key: 'crm.followUpStatus', zh: '跟进状态', en: 'Follow-up status', module: 'crm' },
  { key: 'crm.followUpStatus.pending', zh: '待跟进', en: 'Pending', module: 'crm' },
  { key: 'crm.followUpStatus.followed', zh: '已跟进', en: 'Followed up', module: 'crm' },
  { key: 'crm.followUpStatus.cooperated', zh: '已合作', en: 'Cooperated', module: 'crm' },
  { key: 'crm.followUpDate', zh: '跟进日期', en: 'Follow-up date', module: 'crm' },
  { key: 'crm.followUpHistory', zh: '跟进历史', en: 'Follow-up history', module: 'crm' },
  { key: 'crm.noFollowUpHistory', zh: '暂无跟进记录', en: 'No follow-up records', module: 'crm' },
  { key: 'crm.followUpTask', zh: '跟进任务', en: 'Follow-up task', module: 'crm' },
  { key: 'crm.openFollowUpTask', zh: '打开跟进任务', en: 'Open follow-up task', module: 'crm' },
  { key: 'crm.validation.name', zh: '请填写客户名称', en: 'Please enter a customer name', module: 'crm' },
  { key: 'crm.validation.tracker', zh: '请选择跟进人员', en: 'Please select a tracker', module: 'crm' },
  ...
  { key: 'report.averageProgress', zh: '平均进度', en: 'Average progress', module: 'report' },
  { key: 'report.taskHealth', zh: '任务健康度', en: 'Task health', module: 'report' },
  { key: 'report.dueSoon', zh: '7天内到期', en: 'Due within 7 days', module: 'report' },
  { key: 'report.projectByType', zh: '项目分类统计', en: 'Projects by category', module: 'report' },
  { key: 'report.taskByStatus', zh: '任务状态统计', en: 'Tasks by status', module: 'report' },
  { key: 'report.followUpStatus', zh: '跟进状态统计', en: 'Follow-up status', module: 'report' },
  { key: 'report.overdueTasks', zh: '逾期任务明细', en: 'Overdue task details', module: 'report' },
  { key: 'report.customerProjects', zh: '客户合作项目', en: 'Customer projects', module: 'report' },
  { key: 'report.upcomingFollowUps', zh: '近期客户跟进', en: 'Upcoming follow-ups', module: 'report' },
  { key: 'report.generateSuccess', zh: '报表快照已生成', en: 'Report snapshot generated', module: 'report' },
